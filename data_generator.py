...
class DataGenerator:
    def __init__(self, batch_size: int = 32, num_of_batches: Optional[int] = 1, items_len: int = 5, features_range: int = 10,
                 mut_prob: MutProb_T = (0.35, 0.1, 0.45, 0.05, 0.05), seed: int = 5):
        """ Generates dataset
